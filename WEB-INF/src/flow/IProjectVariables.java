 ...
 * Last generated by Orchestration Designer at: 30 DE MARZO DE 2022 03:43:03 PM COT
 */
public interface IProjectVariables {
	 ...
	 */
	public static final String CONSULTA_PRESTADOR_WS = "consultaPrestadorWS";
	public static final String TIME = "time";
	public static final String MEN_CONFIRMA = "menConfirma";
	public static final String REDIRECTINFO = "redirectinfo";
	public static final String UUIPREFIX = "UUIPrefix";
	public static final String PAC_CONFIRMA_IDENTIFICACION = "pacConfirmaIdentificacion";
	public static final String SESSION = "session";
	public static final String DD_LAST_EXCEPTION = "ddLastException";
	public static final String OBTENER_AIU_IVRRESPUESTA = "obtenerAiuIVRRespuesta";
	public static final String PAC_DIGITA_NIT = "pacDigitaNIT";
	public static final String BLI_TRANSFER = "bliTransfer";
	public static final String DATE = "date";
	public static final String REPETICIONES = "repeticiones";
	public static final String PAC_DIGITA_IDENTIFICACION = "pacDigitaIdentificacion";
	public static final String VDNTRANSFER = "VDNTransfer";
	public static final String CONSULTA_PRESTADOR = "ConsultaPrestador";
	public static final String ERROR_WS = "errorWS";
	public static final String MEN_AUDIO_VALIDACION = "menAudioValidacion";
	public static final String UUIDATA = "UUIData";
	public static final String INSERTA_DATOS_BD = "insertaDatosBD";
	public static final String SHAREDUUI = "shareduui";
	//}}END:PROJECT:VARIABLES
	//{{START:PROJECT:VARIABLEFIELDS
	public static final String CONSULTA_PRESTADOR_WS_FIELD_ID_PRESTADOR = "idPrestador";
	public static final String CONSULTA_PRESTADOR_WS_FIELD_NUMERO_PRESTADORES = "numeroPrestadores";
	...
	public static final String MEN_CONFIRMA_FIELD_CONFIDENCE = "confidence";
	public static final String MEN_CONFIRMA_FIELD_INPUTMODE = "inputmode";
	public static final String MEN_CONFIRMA_FIELD_INTERPRETATION = "interpretation";
	public static final String MEN_CONFIRMA_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MEN_CONFIRMA_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String MEN_CONFIRMA_FIELD_UTTERANCE = "utterance";
	public static final String MEN_CONFIRMA_FIELD_VALUE = "value";
	...
	public static final String PAC_CONFIRMA_IDENTIFICACION_FIELD_CONFIDENCE = "confidence";
	public static final String PAC_CONFIRMA_IDENTIFICACION_FIELD_INPUTMODE = "inputmode";
	public static final String PAC_CONFIRMA_IDENTIFICACION_FIELD_INTERPRETATION = "interpretation";
	public static final String PAC_CONFIRMA_IDENTIFICACION_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String PAC_CONFIRMA_IDENTIFICACION_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String PAC_CONFIRMA_IDENTIFICACION_FIELD_UTTERANCE = "utterance";
	public static final String PAC_CONFIRMA_IDENTIFICACION_FIELD_VALUE = "value";
	...
	public static final String PAC_DIGITA_NIT_FIELD_CONFIDENCE = "confidence";
	public static final String PAC_DIGITA_NIT_FIELD_INPUTMODE = "inputmode";
	public static final String PAC_DIGITA_NIT_FIELD_INTERPRETATION = "interpretation";
	public static final String PAC_DIGITA_NIT_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String PAC_DIGITA_NIT_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String PAC_DIGITA_NIT_FIELD_UTTERANCE = "utterance";
	public static final String PAC_DIGITA_NIT_FIELD_VALUE = "value";
	...
	public static final String PAC_DIGITA_IDENTIFICACION_FIELD_CONFIDENCE = "confidence";
	public static final String PAC_DIGITA_IDENTIFICACION_FIELD_INPUTMODE = "inputmode";
	public static final String PAC_DIGITA_IDENTIFICACION_FIELD_INTERPRETATION = "interpretation";
	public static final String PAC_DIGITA_IDENTIFICACION_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String PAC_DIGITA_IDENTIFICACION_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String PAC_DIGITA_IDENTIFICACION_FIELD_UTTERANCE = "utterance";
	public static final String PAC_DIGITA_IDENTIFICACION_FIELD_VALUE = "value";
	public static final String CONSULTA_PRESTADOR_FIELD_COD_GRABACION = "codGrabacion";
	public static final String CONSULTA_PRESTADOR_FIELD_ID = "id";
	public static final String CONSULTA_PRESTADOR_FIELD_ID_PRESTADOR = "idPrestador";
	public static final String MEN_AUDIO_VALIDACION_FIELD_CONFIDENCE = "confidence";
	public static final String MEN_AUDIO_VALIDACION_FIELD_INPUTMODE = "inputmode";
	public static final String MEN_AUDIO_VALIDACION_FIELD_INTERPRETATION = "interpretation";
	public static final String MEN_AUDIO_VALIDACION_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MEN_AUDIO_VALIDACION_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String MEN_AUDIO_VALIDACION_FIELD_UTTERANCE = "utterance";
	public static final String MEN_AUDIO_VALIDACION_FIELD_VALUE = "value";
	public static final String INSERTA_DATOS_BD_FIELD_DATOS = "datos";
	public static final String INSERTA_DATOS_BD_FIELD_LLAVE = "llave";
	public static final String INSERTA_DATOS_BD_FIELD_RESULTADO = "resultado";
