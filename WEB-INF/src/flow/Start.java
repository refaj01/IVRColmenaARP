...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("anuBienvenida");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.PREFIX, "PD,00;C8,", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.ENCODED_UUI, "", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.PAC_DIGITA_NIT_FIELD_CONFIDENCE,
			IProjectVariables.PAC_DIGITA_NIT_FIELD_INPUTMODE,
			IProjectVariables.PAC_DIGITA_NIT_FIELD_INTERPRETATION,
			IProjectVariables.PAC_DIGITA_NIT_FIELD_NOINPUTCOUNT,
			IProjectVariables.PAC_DIGITA_NIT_FIELD_NOMATCHCOUNT,
		...
		variableFields = new String[] {
			IProjectVariables.MEN_AUDIO_VALIDACION_FIELD_CONFIDENCE,
			IProjectVariables.MEN_AUDIO_VALIDACION_FIELD_INPUTMODE,
			IProjectVariables.MEN_AUDIO_VALIDACION_FIELD_INTERPRETATION,
			IProjectVariables.MEN_AUDIO_VALIDACION_FIELD_NOINPUTCOUNT,
			IProjectVariables.MEN_AUDIO_VALIDACION_FIELD_NOMATCHCOUNT,
			IProjectVariables.MEN_AUDIO_VALIDACION_FIELD_UTTERANCE,
			IProjectVariables.MEN_AUDIO_VALIDACION_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MEN_AUDIO_VALIDACION, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.INSERTA_DATOS_BD_FIELD_DATOS,
			IProjectVariables.INSERTA_DATOS_BD_FIELD_LLAVE,
			IProjectVariables.INSERTA_DATOS_BD_FIELD_RESULTADO };
		...
		variableFields = new String[] {
			IProjectVariables.PAC_DIGITA_IDENTIFICACION_FIELD_CONFIDENCE,
			IProjectVariables.PAC_DIGITA_IDENTIFICACION_FIELD_INPUTMODE,
			IProjectVariables.PAC_DIGITA_IDENTIFICACION_FIELD_INTERPRETATION,
			IProjectVariables.PAC_DIGITA_IDENTIFICACION_FIELD_NOINPUTCOUNT,
			IProjectVariables.PAC_DIGITA_IDENTIFICACION_FIELD_NOMATCHCOUNT,
			IProjectVariables.PAC_DIGITA_IDENTIFICACION_FIELD_UTTERANCE,
			IProjectVariables.PAC_DIGITA_IDENTIFICACION_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PAC_DIGITA_IDENTIFICACION, variableFields, null, session, false, false );
		session.putVariable(variable);
	}
	/**
	...
	public String getEntryName() {
		return("IVR_Colmena_Prestadores_V1.0");
	}
	/**
