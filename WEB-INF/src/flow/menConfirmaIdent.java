 ...
 * Last generated by Orchestration Designer at: 30 DE MARZO DE 2022 06:19:24 PM COT
 */
public class menConfirmaIdent extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Correcto", "1", true, "exact", "insertaDatos", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Incorrecto", "2", true, "exact", "pacDigitaIdentificacion", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("prmConfirmaIdentificacion", ""));
