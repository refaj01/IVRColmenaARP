 ...
 * Last generated by Orchestration Designer at: 30 DE MARZO DE 2022 06:50:12 PM COT
 */
public class pacConfirmaIdentificacion extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 30 DE MARZO DE 2022 06:50:12 PM COT
	 */
	public pacConfirmaIdentificacion() {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("prmConfirmaIdentificacion", ""));

		// build the list of grammar information objects for the field
		String ___tempGrammarName = null;
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("grmConfirmacion", "1.0"));


		// build events for the field: "pacConfirmaIdentificacion"
		...
		int nbest = 1;
		field = new com.avaya.sce.runtime.Field("pacConfirmaIdentificacion", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("datValidaConfirmacionIdentificacion");
		return submit;
	}
	/**
