 ...
 * Last generated by Orchestration Designer at: 30 DE MARZO DE 2022 05:30:00 PM COT
 */
public class pacDigitaNIT extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("prmDigitaNIT", ""));

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("grmDigitaNIT", "1.0"));


		// build events for the field: "pacDigitaNIT"
		...
		nbest = 1;
		field = new com.avaya.sce.runtime.Field("pacDigitaNIT", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("menConfirmaNIT");
		return submit;
	}
	/**
